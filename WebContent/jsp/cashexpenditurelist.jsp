...
<display:table id="data" name="sessionScope.CashExpenditure.cashExpenditureVo" cellspacing="2" export="true"  pagesize="10" cellpadding="2" class="datatable" >
  ...
  <div class="modal-dialog">
    ...
    <html:form action="/user">
      ...
      <div class="modal-body">
		...
		<tr><td align="left">PARTICULARS </td><td>:<input type="text" id="particulars" name="particulars"></td></tr>
