...
<display:table id="data" name="sessionScope.CashPurchase.cashPurchaseVo" cellspacing="2" export="true"  pagesize="10" cellpadding="2" class="datatable" >
  ...
  <div class="modal-dialog">
    ...
    <html:form action="/user">
      ...
      <div class="modal-body">
		...
		<tr><td align="left">AMOUNT </td><td>:<input type="text" id="amount" name="amount"></td></tr>
