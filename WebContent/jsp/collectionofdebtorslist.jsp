...
<display:table id="data" name="sessionScope.CollectionOfDebtors.collectionOfDebtorsVo" cellspacing="2" export="true"  pagesize="10" cellpadding="2" class="datatable" >
  ...
  <div class="modal-dialog">
    ...
    <html:form action="/user">
      ...
      <div class="modal-body">
		...
		<tr><td align="left">PAYMENT </td><td>:<input type="text" id="payment" name="payment"></td></tr>
