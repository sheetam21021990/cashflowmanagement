...
<display:table id="data" name="sessionScope.DepositInBank.depositInBankVo" cellspacing="2" export="true"  pagesize="10" cellpadding="2" class="datatable" >
		<display:column property="slNo" title="SLNO" />
		<display:column property="amountDeposited" title="AMOUNTDEPOSITED" />
		<display:column property="nameOfTheBank" title="NAMEOFTHEBANK" />
  ...
  <div class="modal-dialog">
    ...
    <html:form action="/user">
      ...
      <div class="modal-body">
		...
		<tr><td align="left">AMOUNTDEPOSITED </td><td>:<input type="text" id="amountDeposited" name="amountDeposited"></td></tr>
		<tr><td align="left">NAMEOFTHEBANK </td><td>:<input type="text" id="nameOfTheBank" name="nameOfTheBank"></td></tr>
