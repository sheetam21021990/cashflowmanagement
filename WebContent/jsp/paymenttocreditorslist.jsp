...
<display:table id="data" name="sessionScope.PaymentToCreditors.paymentToCreditorsVo" cellspacing="2" export="true"  pagesize="10" cellpadding="2" class="datatable" >
		<display:column property="slNo" title="SLNO" />
		<display:column property="creditorName" title="CREDITORNAME" />
		<display:column property="amountPaid" title="AMOUNTPAID" />
  ...
  <div class="modal-dialog">
    ...
    <html:form action="/user">
      ...
      <div class="modal-body">
		...
		<tr><td align="left">CREDITORNAME </td><td>:<input type="text" id="creditorName" name="creditorName"></td></tr>
		<tr><td align="left">AMOUNTPAID </td><td>:<input type="text" id="amountPaid" name="amountPaid"></td></tr>
