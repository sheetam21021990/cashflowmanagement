...
<display:table id="data" name="sessionScope.TaxPayment.taxPaymentVo" cellspacing="2" export="true"  pagesize="10" cellpadding="2" class="datatable" >
		<display:column property="slNo" title="SLNO" />
		<display:column property="taxPaid" title="TAXPAID" />
  ...
  <div class="modal-dialog">
    ...
    <html:form action="/user">
      ...
      <div class="modal-body">
		...
		<tr><td align="left">TAXPAID </td><td>:<input type="text" id="taxPaid" name="taxPaid"></td></tr>
